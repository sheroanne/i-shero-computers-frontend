    ...
    async function updateProduct(){
		...
		if (imagePromises.length > 0) {
			try {
				...
				console.log(err);
				// If upload fails, use existing images
				...
				<div className="w-full bg-charcoal/50 p-4 sm:p-6 md:p-8 flex flex-row flex-wrap justify-between gap-4 sm:gap-6 rounded-xl shadow-xl border border-graphite">                    
					<div className="w-full sm:w-[48%]">
						...
						<input
							...
							className="w-full h-12 px-4 rounded-xl focus:outline-none border-2 border-graphite bg-midnight/50 text-text-primary opacity-60 cursor-not-allowed"
						/>
					</div>
					<div className="w-full sm:w-[48%]">
